...
/**
 * \brief Auxiliary function to evaluate expression for "MatVecMultiplyKernel.loopLength".
 */
int MatVecMultiply_get_MatVecMultiplyKernel_loopLength( void );
 ...
 * \param [in] instream_mat The stream should be of size (param_matrixLength * 4) bytes.
 * \param [in] instream_vec The stream should be of size (param_n * 4) bytes.
 * \param [out] outstream_vecOutput The stream should be of size (param_n * 4) bytes.
 */
void MatVecMultiply(
	int64_t param_matrixLength,
	int64_t param_n,
	const float *instream_mat,
	const float *instream_vec,
	float *outstream_vecOutput);
...
typedef struct { 
	...
	const float *instream_mat; /**<  [in] The stream should be of size (param_matrixLength * 4) bytes. */
	const float *instream_vec; /**<  [in] The stream should be of size (param_n * 4) bytes. */
	float *outstream_vecOutput; /**<  [out] The stream should be of size (param_n * 4) bytes. */
